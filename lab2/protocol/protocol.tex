...
Wreszcie, aby aplikacje budowane w procesie tworzenia obrazu mogły być debugowane, należy włączyć opcję dodawania symboli
...
$ /malina/dachb/buildroot-2016.11.2/output/host/usr/bin/arm-none-linux-gnueabi-gdb \ 
  /malina/dachb/simon/simon
(gdb) target remote 192.168.143.xxx:7777
\end{lstlisting}
W wyniku powyższych czynności można debugować kod wykonywany na płytce z poziomu komputera laboratoryjnego, m.in. przechodząc po kolejnych instrukcjach lub ustawiając \emph{breakpoint}.
